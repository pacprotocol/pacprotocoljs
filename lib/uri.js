 ...
 * ```javascript
 *
 * var uri = new URI('pac:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('pac:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6');
 * // true
 * ```
 *
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'pac:') {
    throw new TypeError('Invalid pac URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid pac address');
  }
