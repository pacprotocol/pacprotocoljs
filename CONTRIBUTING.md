...
We're working hard to make *dashcore-lib* the most powerful JavaScript library for working with PAC Protocol. Our goal is to have *dashcore-lib* be a library that can be used by anyone interested in PAC Protocol, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://www.pac.org/forum (Support Forum)
