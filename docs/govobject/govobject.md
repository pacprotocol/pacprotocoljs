...
A Governance Object (or "govObject") is a generic structure introduced in PAC Protocol Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
var jsonProposal = {
  ...
  payment_amount: 10,
  type: 1,
  url: "http://www.pac.org/proposal/first_proposal"
};
...
```javascript
proposal.url = "http://pac.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url = "http://pac.org/fixedUrl"
