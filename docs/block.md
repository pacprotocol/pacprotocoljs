...
For detailed technical information about a block please visit [Blocks](https://docs.pacprotocol.com/en/glossary/block) on the PAC Protocol Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://docs.pacprotocol.com/en/developer-reference#block-headers) page on the PAC Protocol Developer Reference Wiki.
