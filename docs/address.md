# PAC Protocol Address
Represents a PAC Protocol address. Addresses are the most popular way to make PAC Protocol transactions. See [the PAC Protocol documentation](https://docs.pacprotocol.com/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/dashevo/bitcore-pac/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/dashevo/bitcore-pac/tree/master/lib/errors/spec.js).
