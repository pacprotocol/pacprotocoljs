# Public Key
Represents a PAC Protocol public key and is needed to be able to receive funds, as is usually represented as a PAC Protocol [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
